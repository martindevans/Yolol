...
namespace YololEmulator.Tests.Analysis.Reduction
{
    ...
    public class VariableSimplificationTests
    {
        ...
        public void SimplifyVarNames()
        {
            ...
            var ast = Parser.TryParse(Tokenizer.TryTokenize("ship=7 counter=0 ship=6").Value).Value;
            ...
            Assert.AreEqual("a=7 b=0 a=6", reduced);
        }
        ...
        public void LotsOfUniqueNames()
        {
            ...
            for (var i = 0; i < 1000; i++)
                Assert.IsTrue(h.Add(n.Name(i.ToString())));
        }
    }
}
