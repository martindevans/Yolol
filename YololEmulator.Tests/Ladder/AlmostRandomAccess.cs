...
namespace YololEmulator.Tests.Ladder
{
        ...
        : BaseGenerator
    {
        ...
        private static BaseAccessStrategy PickStrategy(Random random)
        {
            ...
            : BaseAccessStrategy
        {
            ...
            public override bool IsComplete => _rand.NextDouble() < 0.15 || _addr >= 1000;

            public SequentialAccess(Random rand)
            {
                _rand = rand;
                _addr = rand.Next(1024);
            }
